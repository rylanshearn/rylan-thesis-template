...
\usepackage[table,xcdraw]{xcolor} %important for table colors
\usepackage{gensymb}
\graphicspath{ {images/} }
...
\usepackage{nameref} % % required for hyperef
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % Alter the level of paragraphs so numbers are added
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
\usepackage{titlesec}
...
\begin{document}
	...
	\begin{titlingpage}
		...
		\begin{center}
			...
			\vspace{3mm}
			%Author's name
			{\Large Rylan James Shearn, BSc Hons}\\
			\vspace{5mm}
			%Graphic
			\begin{figure}[h]
				\centering
